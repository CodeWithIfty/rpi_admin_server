...
const UpdatePublicationInformation = async (req, res) => {
  const id = req.params.id;
  try {
    // Find the existing address information by ID
    const existingAddress = await EmployeePublication.findByPk(id);
...
module.exports = { UpdatePublicationInformation };
